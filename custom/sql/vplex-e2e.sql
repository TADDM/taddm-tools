...
ARRAYSV.NAME_C AS ArrayVolume,
BACKARRAY.SERIALNUMBER_C AS BackendArray,
...
LEFT JOIN BB_STORAGEEXTENTJDO_BASEDON_J SV_BOE ON VPLEXSV.PK_C = SV_BOE.PK__JDOID_C
LEFT JOIN BB_BASEDONEXTENT34_V BOE ON BOE.PK_C = SV_BOE.PK__BASEDON_C
LEFT JOIN BB_STORAGEVOLUME95_V ARRAYSV ON BOE.TARGET_C = ARRAYSV.GUID_C
LEFT JOIN BB_STORAGESUBSYBERS_8D5F5384J ARRAY_SV ON ARRAYSV.PK_C = ARRAY_SV.PK__MEMBERS_C
LEFT JOIN BB_STORAGESUBSYSTEM16_V BACKARRAY ON BACKARRAY.PK_C = ARRAY_SV.PK__JDOID_C
